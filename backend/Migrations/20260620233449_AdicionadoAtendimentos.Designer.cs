...
namespace NeuroGest.API.Migrations
{
    ...
    [Migration("20260620233449_AdicionadoAtendimentos")]
    partial class AdicionadoAtendimentos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeuroGest.API.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumRegistro = "",
                            Perfil = "admin",
                            SenhaHash = "$2a$11$zp9JfGWTIf8cQ6ShEenfmu2R3FCpP0d0eG0KFODh.yvpfn2Ao/aYS",
                            TipoRegistro = ""
                        });
                });
