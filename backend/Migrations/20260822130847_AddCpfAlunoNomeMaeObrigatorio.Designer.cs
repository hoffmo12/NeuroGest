...
namespace NeuroGest.API.Migrations
{
    ...
    [Migration("20260822130847_AddCpfAlunoNomeMaeObrigatorio")]
    partial class AddCpfAlunoNomeMaeObrigatorio
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeuroGest.API.Models.Agendamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NeuroGest.API.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumRegistro = "",
                            Perfil = "admin",
                            SenhaHash = "$2a$11$Hni9PfQQV8p9/3xx4C1GOual2SXYD2KXyRz0G0cYWB4aGmVIEZ0eK",
                            TipoRegistro = ""
                        });
                });
