...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _carregarUsuario() async {
    funcionario = FuncionarioRepository().buscarPorLogin(
      widget.email,
    )!; //TODO: buscar da API o usuário correto
  }

  bool get _podeVerAtendimentos => true;
  bool get _podeVerAlunos => true;
  bool get _podeVerFinanceiro =>
      funcionario.nivelDeAcesso == 'admin' ||
      funcionario.nivelDeAcesso == 'gerente';
  bool get _podeVerFuncionarios => funcionario.nivelDeAcesso == 'admin';
  ...
  Future<void> _sair() async {
    // await AuthService.logout(); //TODO: validar posteriormente
    if (!mounted) return;
  ...
  String get _iniciais {
    final partes = funcionario.nome.trim().split(' ');
    if (partes.length >= 2) {
      return '${partes.first[0]}${partes.last[0]}'.toUpperCase();
    }
    return funcionario.nome.isNotEmpty
  ...
  Widget _badgePerfil() {
    ...
    final (cor, label) =
        map[funcionario.nivelDeAcesso] ??
        (const Color(0xFF9E9E9E), 'Não identificado');
    return Container(
                ...
                child: NeuroPanel(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (funcionario.nome.isNotEmpty) ...[
                        Container(
                      ...
                      Container(
                        ...
                        child: _moduloCard(
                          ...
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              //TODO: fazer o calendário
                              builder: (_) =>
                                  AtendimentoScreen(funcionario: funcionario),
                            ),
                          ),
                        ),
                      ),
