          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(
                  color: hasError ? Colors.red.shade700 : Colors.black, width: 3),
  ...
  Future<void> _salvar() async {
    ...
    if (_editando) {
      erro = await AlunoService.editar(
        ...
        nomePai:             _nomePaiController.text.trim().isEmpty ? null : _nomePaiController.text.trim(),
        nomeMae:             _nomeMaeController.text.trim().isEmpty ? null : _nomeMaeController.text.trim(),
        cpfPai:              _cpfPaiController.text.trim().isEmpty ? null : _cpfPaiController.text.trim(),
        cpfMae:              _cpfMaeController.text.trim().isEmpty ? null : _cpfMaeController.text.trim(),
        telefoneResponsavel: _telefoneController.text.trim().isEmpty ? null : _telefoneController.text.trim(),
