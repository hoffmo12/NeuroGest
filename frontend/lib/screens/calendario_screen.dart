...
class _CalendarioScreenState extends State<CalendarioScreen> {
                ...
                Row(
                  children: [
                    ...
                    if (evento.temAtendimento)
                      const Tooltip(
                        message:
                            'Não é possível alterar: já existe atendimento registrado.',
                        child: Icon(
                          Icons.lock_outline,
                          size: 16,
                          color: Colors.grey,
  ...
  Widget build(BuildContext context) {
    ...
    final inicioCalendario = primeiroDia.subtract(
                        ...
                        Expanded(
                          child: ScrollConfiguration(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (_, index) {
                                final dia = inicioCalendario.add(
                                  Duration(days: index),
                                );
