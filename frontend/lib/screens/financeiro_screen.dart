                  ...
                  children: [
                    ...
                    Expanded(
                      child: _ResumoCard(
                        ...
                        subtitulo: '$qtdEmAberto debitos pendentes',
                                    ...
                                    : BarChart(
                                        BarChartData(
                                          ...
                                          barGroups: List.generate(12, (index) {
                                            final recebido =
                                                _valoresPorMes[index].recebido.toDouble();
                                            final aberto =
                                                _valoresPorMes[index].aberto.toDouble();
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<int>(
                                ...
                                items: const [
                                  ...
                                  DropdownMenuItem(value: 3, child: Text('Marco')),
  ...
  void _abrirModalNovoLancamento() async {
    ...
    if (alunos.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Nenhum aluno encontrado.')),
      );
      return;
    }
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<Aluno>(
                  ...
                  items: alunos.map((a) =>
                      DropdownMenuItem(value: a, child: Text(a.nome))).toList(),
                  onChanged: (value) async {
                    ...
                    if (value != null) {
                      final lista = await AtendimentoService.listarPorAluno(value.id);
                ...
                DropdownButtonFormField<int>(
                  ...
                  items: atendimentosDoAluno.map((a) => DropdownMenuItem<int>(
                    value: a.id,
                    child: Text('Atendimento #${a.id} · ${_formatarData(a.dataAtendimento)}'),
                  )).toList(),
                  onChanged: atendimentosDoAluno.isEmpty
                      ? null
                      : (value) => setModalState(() => atendimentoSelecionadoId = value),
                  hint: Text(alunoSelecionado == null
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (resultado.erro != null) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(resultado.erro!)),
                );
              } else {
