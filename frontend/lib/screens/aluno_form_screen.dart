...
class _AlunoFormScreenState extends State<AlunoFormScreen> {
  ...
  bool _validar() {
    setState(() {
      ...
      _errData = _dataSelecionada == null
      ...
      _errNomeMae = _nomeMaeCtrl.text.trim().isEmpty
  ...
  Future<void> _salvar() async {
    ...
    final String? municipio = _municipioCtrl.text.trim().isEmpty
        ? null
        : _municipioCtrl.text.trim();
    final String? sexo = _sexoCtrl.text.trim().isEmpty
        ? null
        : _sexoCtrl.text.trim();
    final String? estado = _estadoCtrl.text.trim().isEmpty
        ? null
        : _estadoCtrl.text.trim();
    final String? nomePai = _nomePaiCtrl.text.trim().isEmpty
        ? null
        : _nomePaiCtrl.text.trim();
    final String nomeMae = _nomeMaeCtrl.text.trim();
    final String cpf = _cpfCtrl.text.trim();
    final String? telefoneResponsavel = _telCtrl.text.trim().isEmpty
        ? null
        : _telCtrl.text.trim();
    final String? observacoes = _obsCtrl.text.trim().isEmpty
        ? null
        : _obsCtrl.text.trim();
          ...
          child: Padding(
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                children: [
                  NeuroHeaderTitle(
                    title: _isEdicao ? 'EDITAR ALUNO' : 'ADICIONAR ALUNO',
                  ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _ValidatedField(
                                    ...
                                    hint:
                                        'Informações adicionais... (Ex: Alergias)',
                                    controller: _obsCtrl,
                                  ),
