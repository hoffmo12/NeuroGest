  ...
  doc.addPage(
    pw.MultiPage(
      ...
      build: (context) => [
        ...
        _secao('Anamnese', corPrimaria, [
          _blocoTexto(a.anamnese),
        ]),
        ...
        _secao('Exame físico', corPrimaria, [
          ...
          _linhaCampos([
            _campo('Perímetro cefálico (cm)', a.perimetroCefalico.toStringAsFixed(1)),
            _campo('Circunf. abdominal (cm)', a.circunferenciaAbdominal.toStringAsFixed(1)),
            _campo('Perímetro panturrilha (cm)', a.perimetroPanturrilha.toStringAsFixed(1)),
          ]),
          pw.SizedBox(height: 8),
          _blocoTexto(a.exameFisico),
        ]),

        _secao('Diagnóstico', corPrimaria, [
          _blocoTexto(a.diagnostico),
        ]),
          ...
          children: [
            pw.Column(
              children: [
                ...
                pw.Text(
                  a.nomeUsuario.isEmpty ? 'Assinatura do profissional' : a.nomeUsuario,
